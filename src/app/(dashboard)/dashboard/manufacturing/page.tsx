    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500">Bill of Materials and Work Orders</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="flex items-center gap-3">
            ...
            <div><p className="text-sm text-zinc-500">Total BOMs</p><p className="text-2xl font-bold text-white">{stats.totalBOMs}</p></div>
          </div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-green-500/10 p-2"><FileCode className="h-5 w-5 text-green-400" /></div>
            <div><p className="text-sm text-zinc-500">Active BOMs</p><p className="text-2xl font-bold text-white">{stats.activeBOMs}</p></div>
          </div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-purple-500/10 p-2"><Cog className="h-5 w-5 text-purple-400" /></div>
            <div><p className="text-sm text-zinc-500">Work Orders</p><p className="text-2xl font-bold text-white">{stats.totalWOs}</p></div>
          </div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-orange-500/10 p-2"><PlayCircle className="h-5 w-5 text-orange-400" /></div>
            <div><p className="text-sm text-zinc-500">In Progress</p><p className="text-2xl font-bold text-white">{stats.activeWOs}</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="p-4">
            {boms.length === 0 ? (
              <div className="text-center py-8">
                <FileCode className="mx-auto h-10 w-10 text-zinc-700" />
                <p className="mt-2 text-zinc-500">No BOMs created yet</p>
                <p className="text-xs text-zinc-600 mt-1">Create a BOM to define product components</p>
              </div>
            ) : (
              <BOMsTable boms={boms} />
            )}
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
          ...
          <div className="p-4">
            {workOrders.length === 0 ? (
              <div className="text-center py-8">
                <Cog className="mx-auto h-10 w-10 text-zinc-700" />
                <p className="mt-2 text-zinc-500">No work orders yet</p>
                <p className="text-xs text-zinc-600 mt-1">Create a work order to schedule production</p>
              </div>
            ) : (
